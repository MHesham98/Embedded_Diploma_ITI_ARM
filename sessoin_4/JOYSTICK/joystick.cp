#line 1 "C:/Embedded/sessoin_4/JOYSTICK/joystick.c"
...
{ int i=0;
 ...
 while(Button(&GPIOD_IDR, 4 , 30 , 0 )==255)
 {
 ...
 else if(Button(&GPIOB_IDR, 5 , 30 , 0 )==255)
 {
 --i;
 ...
 while(Button(&GPIOB_IDR, 5 , 30 , 0 )==255)
 {
 ...
 else if(Button(&GPIOA_IDR, 6 , 30 , 0 )==255)
 {
 ...
 while(Button(&GPIOA_IDR, 6 , 30 , 0 )==255)
 {
 ...
 else if(Button(&GPIOD_IDR, 2 , 30 , 0 )==255)
 { ++j;
 if(j==4 && port == 'd')
 {
 ...
 while(Button(&GPIOD_IDR, 2 , 30 , 0 )==255)
 {
